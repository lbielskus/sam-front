        ...
        <section className='flex justify-between max-md:flex-col space-x-4 '>
                        ...
                        <ul className='space-y-4'>
                          <li className='flex items-center gap-4 justify-between'>
                            ...
                            <div>
                              ...
                              <dl className='mt-0.5 space-y-px text-[15px] text-text'>
                                <p>
                                  €{' '}
                                  {cartProducts.filter(
                                    (id) => id === product._id
                  ...
                  <div className='mt-8 flex justify-end border-t border-gray-100 pt-8'>
                    <div className=' max-w-md space-y-4'>
                      ...
                      <div className='flex justify-end'>
                        <Link
                          className='group flex items-center justify-between gap-4 rounded-lg border border-current px-4 py-2  text-third active:bg-hove3   transition-colors hover:bg-hover3 focus:outline-none focus:ring '
                          href='/products'
                        >
                          ...
                          <span className='shrink-0 rounded-full border  p-2 group-active:border-hover3 group-hover:text-white'>
                            <svg
          ...
          {!products.length ? (
            ...
            <div className='md:1/3 mt-16 md:mt-6'>
              ...
              <div className='mx-auto max-w-xl p-4 border my-3 shadow-md-left'>
                  ...
                  <div className='grid grid-cols-12 gap-5'>
                    ...
                    <div className='col-span-12 text-center w-full'>
                      <button
                        ...
                        className='disabled block rounded bg-third px-5 py-3 text-md text-white transition hover:bg-hover3 w-full'
                      >
                        Checkout
                      </button>
                    </div>
