        ...
        <div className='mt-14 md:mt-6 w-full px-4 md:p-0 ml-4 mr-4'>
          ...
          {filteredProducts.length === 0 ? (
            ...
            <>
              ...
              <div className='ml-16 grid grid-cols-1 gap-x-3 md:gap-x-6 gap-y-10 sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-3 xl:gap-x-8'>
